...
This is a sample template for ProductionMonitoringServerless - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name productionmonitoringserverless \
...
aws cloudformation describe-stacks \
    --stack-name productionmonitoringserverless --query 'Stacks[].Outputs'
```
